                                ...
                                <form method="post" class="product-form">
                                    <div class=" misc d-flex align-items-end justify-content-between mt-4">
                                        <div class="quantity d-flex align-items-center justify-content-between">
                                            <span class="qty-btn dec-qty"><img src="assets/img/icon/minus.svg" alt="minus"></span>
                                            <input class="qty-input" type="number" name="qty" value="1" min="0">
                                            <span class="qty-btn inc-qty"><img src="assets/img/icon/plus.svg" alt="plus"></span>
                                        </div>
                                    </div>


                                    <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                        <button type="submit" name="addtocart" class="position-relative btn-atc btn-add-to-cart loader">ADD TO CART</button>
                                        <a href="/addtowish?pid=<?= $productid; ?>" class="product-wishlist">
                                    ...
                                    if (isset($_POST["addtocart"])) {
                                        // var_dump($_POST);
                                        if (!isset($_SESSION["user"])) {
                                            echo "<script>location.href='/login';alert('You are not logged in!')</script>";
                                        } else {
                                            $qty = (int)$_POST["qty"];
