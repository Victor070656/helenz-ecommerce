                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="filter-sort-wrapper d-flex justify-content-between flex-wrap">
                                <div class="collection-title-wrap d-flex align-items-end">
                                    ...
                                    <p class="collection-counter text_16 mb-0 ms-2">(<?=$getProducts->num_rows;?> items)</p>
                                </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                            <div class="product-card shadow-sm">
                                                <div class="product-card-img">
                                                    <a class="hover-switch" href="/product?pid=<?= $products["productid"]; ?>">
                                                        <img class="primary-img" src="uploads/<?= $products["image"]; ?>" style="height: 320px; width: 100%; object-fit: contain; background-color: #fff; " alt="product-img" />
                                                    </a>
                                                    ...
                                                    <div class="product-card-action product-card-action-2 justify-content-center">
                                                        ...
                                                        <a href="/addtowish?pid=<?= $products["productid"]; ?>" class="action-card action-wishlist">
                                                        ...
                                                        <a href="/addtocart?pid=<?= $products["productid"]; ?>" class="action-card action-addtocart">
                                                ...
                                                <div class="product-card-details px-2 pb-2">
                                                    ...
                                                    <h3 class="product-card-title text-truncate">
                                                        <a class="" href="/product?pid=<?= $products["productid"]; ?>"><?= $products["name"]; ?></a>
                                                    </h3>
                                                    <?php if ($products["discount"] > 0) : ?>
                                                        <div class="product-card-price">
                                                            <span class="card-price-regular">$<?= $discount; ?></span>
                                                            <span class="card-price-compare text-decoration-line-through">$<?= $products["price"]; ?></span>
                                                        </div>
                                                    <?php else : ?>
                                                        <div class="product-card-price">
