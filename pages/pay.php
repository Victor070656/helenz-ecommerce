...
dd($_SESSION["pay"]);
                    ...
                    $fields = [
                        ...
                        'callback_url' => "http://localhost:18000/pay?msg=success",
                        'metadata' => ["cancel_action" => "http://localhost:18000/cart"]
                    ];
