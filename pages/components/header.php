                    ...
                    <div class="announcement-meta d-flex align-items-center">
                        ...
                        <?php else : ?>
                            <div class="btn-group ms-2">
                                <button class="btn btn-link text-light text-decoration-none dropdown-toggle" type="button" id="triggerId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-4">
                    <div class="header-logo">
                        <a href="/" class="logo-main">
                            <h2>Helen<span class="text-danger">z</span></h2>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 d-lg-block d-none">
                    <nav class="site-navigation">
                        <ul class="main-menu list-unstyled justify-content-center">
                            <li class="menu-list-item nav-item <?= parse_url($_SERVER["REQUEST_URI"])["path"] == "/" ? "active" : ""; ?> ">
                            ...
                            <li class="menu-list-item nav-item <?= parse_url($_SERVER["REQUEST_URI"])["path"] == "/contact" ? "active" : ""; ?>">
                ...
                <div class="col-lg-3 col-md-8 col-8">
                    <div class="header-action d-flex align-items-center justify-content-end">
                        <?php if (parse_url($_SERVER["REQUEST_URI"])["path"] == "/shop") : ?>
                        ...
                        <?php endif; ?>
                        <a class="header-action-item header-wishlist ms-4 d-none d-lg-block" href="<?= isset($_SESSION["user"]) ? '/wish' : '/login'; ?>">
                        ...
                        <a class="header-action-item header-cart ms-4" href="<?= isset($_SESSION["user"]) ? '/cart' : '/login'; ?>">
