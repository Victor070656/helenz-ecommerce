                                ...
                                <form method="post" class="">
                                    <div class="row">
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["firstname"]; ?>" name="first" required id="first" placeholder="" />
                                            <label>&nbsp; First Name</label>
                                        </div>
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["lastname"]; ?>" name="last" required id="last" placeholder="" />
                                            <label>&nbsp; Last Name</label>
                                        </div>
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["username"]; ?>" name="username" required id="username" placeholder="" />
                                            <label>&nbsp; Username</label>
                                        </div>
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["phone"]; ?>" name="phone" required id="phone" placeholder="" />
                                            <label>&nbsp; Phone Number <small>(E.g +234 -----)</small></label>
                                        </div>
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["email"]; ?>" name="email" required id="email" placeholder="" />
                                            <label>&nbsp; Email</label>
                                        </div>
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control" value="<?= $user["password"]; ?>" name="password" required id="password" placeholder="" />
