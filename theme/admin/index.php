...
<!-- Mirrored from polygons.space/circl/theme/templates/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 10:50:17 GMT -->

<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Helenz footwear Dashboard">
  ...
  <link href="theme/assets/plugins/apexcharts/apexcharts.css" rel="stylesheet">
...
<body>
    ...
    <div class="page-content">
      <div class="main-wrapper">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><img src="theme/assets/images/avatars/profile-image-1.png" alt="">Anna Doe</th>
                        <td>Modern</td>
                        <td>#53327</td>
                        <td>$20</td>
                      ...
                      <tr>
                        <th scope="row"><img src="theme/assets/images/avatars/profile-image-2.png" alt="">John Doe</th>
                        <td>Alpha</td>
                        <td>#13328</td>
                        <td>$25</td>
                      ...
                      <tr>
                        <th scope="row"><img src="theme/assets/images/avatars/profile-image.png" alt="">John Doe</th>
                        <td>Circl Admin</td>
                        <td>#73423</td>
                        <td>$23</td>
                      ...
                      <tr>
                        <th scope="row"><img src="theme/assets/images/avatars/profile-image-1.png" alt="">Nina Doe</th>
                        <td>Space</td>
                        <td>#54773</td>
                        <td>$20</td>
                        <td><span class="badge bg-success">Paid</span></td>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-4">
            <div class="card">
              <img src="theme/assets/images/card-bg.jpg" class="card-img-top" alt="...">
              <div class="card-body">
  ...
  <script src="theme/assets/plugins/apexcharts/apexcharts.min.js"></script>
  <script src="theme/assets/js/main.min.js"></script>
  <script src="theme/assets/js/pages/dashboard.js"></script>
</body>

<!-- Mirrored from polygons.space/circl/theme/templates/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 10:50:36 GMT -->
