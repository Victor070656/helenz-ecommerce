...
if (isset($_GET["oid"])) {
    ...
    echo "<script>location.href='/show-orders'</script>";
}
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <p class="mb-1"><span class="fw-bold">Amount Paid:</span> $<?= $orders["amount"]; ?></p>
                                        <p class="mb-1"><span class="fw-bold">Status:</span> <?= $orders["status"]; ?></p>
                                        <h6 class="mt-0 pt-0">Order to be delivered between <b><?= $first_date; ?></b> and <b><?= $second_date; ?></b></h6>

                                        <span class="text-decoration-underline text-secondary">Reciever Info</span>
                                        <p class="mb-1"><span class="fw-bold">Name:</span> <?= $orders["firstname"] . " " . $orders["lastname"]; ?></p>
                                        <p class="mb-1"><span class="fw-bold">Phone Number:</span> <?= $orders["phone"]; ?></p>
                                        <p class="mb-1"><span class="fw-bold">Email:</span> <?= $orders["email"]; ?></p>
                                        <p class="mb-1"><span class="fw-bold">Location:</span> <?= $orders["address1"] . ", " . $orders["city"] . ", " . $orders["country"]; ?></p>
                                                        ...
                                                        <table class="table invoice-table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        <th scope="row">
                                                                            <img class="img-fluid" style="object-fit: contain" src="uploads/<?= $product["image"]; ?>" </th>
                                                                        <td>
            ...
            <!-- Modal -->
            <div class="modal fade" id="modalId" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true" style="backdrop-filter: blur(5px)">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post">
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <select class="form-select" name="status">
                                        ...
                                        ?>
                                            <option <?= $option == $orders["status"] ? "selected" : ""; ?>><?= $option; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            if (isset($_POST["update-status"])) {
                                ...
                                if ($updateStatus) {
                                    echo "<script>alert('Status Updated!');location.href='/order-detail?oid=$orderid'</script>";
                                } else {
