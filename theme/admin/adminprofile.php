                ...
                <form method="post">
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="email" class="form-control" name="price" placeholder="Email" required>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label">Password</label>
                      <input type="text" step="any" name="discount" class="form-control" required placeholder="Password">
                    </div>
