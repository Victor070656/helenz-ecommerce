        ...
        <main id="MainContent" class="content-for-layout">
            <div class="about-page">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="about-hero-content">
                                    <h2 class="about-hero-title">Welcome to Aesthetics By Lozik</h2>
                                    <p class="about-hero-subtitle">
                                        At Aesthetics By Lozik, we believe that every step you take should be a step in
                                        style, comfort, and confidence. Established in [Year], our mission has always
                                        been to provide high-quality, fashionable footwear that meets the diverse needs
                                        of our customers. Whether you're looking for everyday essentials, seasonal
                                        trends, or eco-friendly options, Aesthetics By Lozik has you covered.
                                    </p>
                                    <p class="about-hero-subtitle">
                                        Aesthetics By Lozik was born out of a passion for shoes and a commitment to
                                        quality.
                                        Our founder, Helen Ogochukwu Nwiba, envisioned a brand where fashion meets
                                        functionality. From humble beginnings as a small boutique, we have grown into a
                                        trusted name in the footwear industry, known for our innovative designs and
                    ...
                    <div class="row g-0 justify-content-center">
                        <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                            <div class="promotional-item overlay-blue">
                                <img src="assets/img/instagram/s9.jpg" alt="img"
                                ...
                                <div class="promotional-absolute">
                                    <div class="promotional-content text-center">
                                        ...
                                        <p class="promo-subtitle">At Aesthetics By Lozik, quality is at the heart of
                                            everything we do. We source the finest materials and employ skilled artisans
                                            to create shoes that are not only stylish but also durable.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                            <div class="promotional-item overlay-black">
                                <img src="assets/img/instagram/s5.jpg" alt="img"
                                    style="height: 450px; width: 100%; object-fit: cover; ">
                                <div class="promotional-absolute">
                                    <div class="promotional-content text-center">
                                        <h2 class="promo-title">Sustainability</h2>
                                        <p class="promo-subtitle">We are dedicated to making a positive impact on the
                                            planet. Our eco-friendly collection features shoes made from sustainable
                                            materials, designed to reduce our environmental footprint. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1000">
                            <div class="promotional-item overlay-yellow">
                                <img src="assets/img/instagram/s7.jpg" alt="img"
                                    style="height: 450px; width: 100%; object-fit: cover; ">
                                <div class="promotional-absolute">
                                    <div class="promotional-content text-center">
                                        <h2 class="promo-title">Customer Commitment</h2>
                                        <p class="promo-subtitle">Our customers are our top priority. We strive to
                                            provide an exceptional shopping experience, both online and in-store. From
                                            our user-friendly website to our attentive customer service team.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="about-service pt-100 pb-100">
                    <div class="container">
                        <div class="section-header about-service-header text-center" data-aos="fade-up"
                                ...
                                <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1000">
                                    <div class="about-service-inner text-center">
                                        ...
                                        <div class="about-service-content">
                                            ...
                                            <p class="about-service-subtitle">Browse our extensive collection from the
                                                comfort of your home. Our user-friendly website is designed to provide a
                                                seamless shopping experience, with detailed product descriptions,
                                                high-quality images, and customer reviews.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1400">
                                    <div class="about-service-inner text-center">
                                        ...
                                        <div class="about-service-content">
                                            ...
                                            <p class="about-service-subtitle">Make your footwear uniquely yours with our
                                                customization services. Choose from a variety of options including
                                                colors, materials, and even personalized monograms.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1700">
                                    <div class="about-service-inner text-center">
                                        ...
                                        <div class="about-service-content">
                                            ...
                                            <p class="about-service-subtitle">Enjoy fast and reliable shipping on all
                                                orders. We offer standard, expedited, and international shipping options
